        ...
        return (
            <>
                ...
                </select>
                {
                    this.state.binderItem.id ?
                    <>
                        <button onClick={this.handleAddCardClick}> Add cards </button>
                        <button onClick={this.handleEditBinderClick}> Edit </button>
                        <button onClick={this.handleBinderDelete}> Delete </button>
                    </> :
                    null
                }
                </div>
